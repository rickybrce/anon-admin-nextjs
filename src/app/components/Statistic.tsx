...
import { getBurTokenDlrRatio, getNumUserGames, getTokenBurnedPercentage, getTokenPrice, getUserPlacedBetsActiveGames, getUserSumPrizePool } from "../api/stats";
...
const Statistic = ({}: Props) => {
  ...
  useEffect(() => {
    ...
    //Get token burned percentage
    (async () => {
      const items = await getTokenBurnedPercentage();
      //Set token burned percentage
      items && setKinBurned(items);
    })();
